            ...
            <div class="row flex-grow-1">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h6 class="card-title mb-0">Khách hàng mới</h6>
                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h6 class="card-title mb-0">Nick đã bán</h6>
                                <div class="dropdown mb-2">
                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h6 class="card-title mb-0">Tăng trưởng</h6>
                                <div class="dropdown mb-2">
                    ...
                    <div class="row align-items-start">
                        <div class="col-md-7">
                            <p class="text-muted tx-13 mb-3 mb-md-0">
                                Doanh thu là thu nhập mà doanh nghiệp có được từ các hoạt động kinh doanh thông thường, thường là từ việc bán hàng hóa và dịch vụ cho khách hàng.</p>
                        </div>
                        <div class="col-md-5 d-flex justify-content-md-end">
                            <div class="btn-group mb-3 mb-md-0" role="group"
                                ...
                                <button type="button"
                                    class="btn btn-outline-primary d-none d-md-block">Tuần này</button>
                                <button type="button" class="btn btn-primary">Tháng này</button>
