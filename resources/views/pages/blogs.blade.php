         ...
         <form class="form-horizontal form-find m-b-20" role="form" method="get" data-hs-cf-bound="true">
             <div class="row">
                ...
                <div class="col-md-4">
                   ...
                   <a class="btn c-btn-square m-b-10 btn-danger" href="{{ route('blogs') }}">Tất cả</a>
                </div>
             </div>
          </form>
          <div class="row">
                ...
                <div class="art-list">
                  ...
                  <div class="a-item">
                     <div class="thumbnail-image img-thumbnail">
                        ...
                        <img src="{{asset('uploads/blog/'.$blog->image)}}" alt="png-image"></a></div>
                     <div class="info">
                        <div class="article_title ">
                           <h2><a href="{{ route('blog_detail',[$blog->slug]) }}" style="text-transform: initial;">{{ $blog->title }}</a></h2>
                        </div>
