    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item"><a href="{{ route('mua-nick-slug', [$category->slug]) }}" title="{{ $category->title }}">{{ $category->title }}</a></li>
            </ol>
        </nav>
        <div class="row">
            <div class="col-sm-12">
                <div class="alert alert-info box-text showtext" role="alert">
                    ...
                    <table align="center" border="1" cellpadding="1" cellspacing="1"
                        ...
                        <tbody>
                            <tr>
                                <td><span style="color:#000000"><span style="font-size:16px">✅&nbsp;<strong>Mua acc {{ $category->title }} giá rẻ</strong></span></span></td>
                            ...
                            <tr>
                                <td><span style="color:#000000"><span style="font-size:16px">✅&nbsp;<strong>Mua nick
                                    {{ $category->title }} uy tín</strong></span></span></td>
                            ...
                            <tr>
                                <td><span style="color:#000000"><span style="font-size:16px">✅&nbsp;<strong>Mua acc {{ $category->title }} nhanh</strong></span></span></td>
                            ...
                            <tr>
                                <td><span style="color:#000000"><span style="font-size:16px">✅&nbsp;<strong>Nick {{ $category->title }} đa dạng</strong></span></span></td>
                    ...
                    <p><span style="font-size:16px"><strong><a href="https://nick.vn/garena/lien-quan"
                                    target="_blank">Web mua bán nick {{ $category->title }} UY TÍN - GIÁ RẺ</a></strong>.
                            <strong>Shop bán acc<strong> </strong>{{ $category->title }}</strong> - <strong>Tài khoản {{ $category->title }}
                                Vip</strong>, <strong>Nick Liên quân có đá quý.</strong>&nbsp;</span></p>
                    <p><span style="font-size:16px"><span style="color:#000000">Ngoài mua&nbsp;bán nick {{ $category->title }} website còn</span> <strong><a href="https://nick.vn/mua-the"
                ...
                <div style="text-align: center;margin: 15px 0">
                    <span class="viewless">Xem tất cả »</span>
                </div>
            </div>
        </div>
            ...
            @foreach ($nicks as $nick)
                <div class="col-sm-6 col-md-3">
                    <div class="classWithPad">
                        <div class="image">
                            <a href="{{ route('nick-detail',[$nick->code]) }}">
                                <img src="{{asset('uploads/nick/'.$nick->image)}}" alt="png-image">
                                <span class="ms">MS: {{ $nick->code }}</span>
                            </a>
                        </div>
                        ...
                        <div class="a-more">
                            <div class="row">
                                ...
                                <div class="col-xs-6 ">
                                    <div class="view">
                                        <a href="{{ route('nick-detail',[$nick->code]) }}">Chi tiết</a>
                    ...
                    <div id="tab1" class="panel-collapse collapse in" aria-expanded="true" style="">
                        <div class="panel-body">
                            ...
                            <p>Ngoài&nbsp; <strong>shop bán acc liên quân</strong>&nbsp;Shop còn có các dịch vụ khác như
                                <strong><a href="https://nick.vn/dich-vu/ban-quan-huy" target="_blank">mua bán quân
                                        huy giá rẻ</a></strong>, <strong><a
                                        href="https://nick.vn/mua-ban-nick-game-random" target="_blank">bán nick liên
                                        quân&nbsp;</a></strong><strong><a
                                        href="https://nick.vn/mua-ban-nick-game-random"
...
<script>
    $(document).ready(function () {
        var table = $(".table"); // Chọn phần tử bảng
        var viewButton = $(".viewless"); // Chọn nút "Thu gọn"/"Xem thêm"
        ...
        // Thay đổi trạng thái và nội dung khi nút được click
        viewButton.click(function () {
            if (isTableVisible) {
                table.hide();
                viewButton.text("Xem tất cả »");
            } else {
                table.show();
                viewButton.text("« Thu gọn");
            }
